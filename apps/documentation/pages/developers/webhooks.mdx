...
You can create a webhook subscription from the user settings page. Click on your avatar in the top right corner of the dashboard and select "**[User settings](https://app.tiquo.co/settings)**" from the dropdown menu.
...
Then, navigate to the "**[Webhooks](https://app.tiquo.co/settings/webhooks)**" tab, where you can see a list of your existing webhooks and create new ones.
