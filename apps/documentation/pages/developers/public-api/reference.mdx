...
The Swagger UI for the API is available at [/api/v1/openapi](https://app.tiquo.co/api/v1/openapi). This page provides detailed information about the API endpoints, request and response formats, and authentication requirements.
  ...
  "recipients": [
    {
      ...
      "role": "SIGNER",
      "signingOrder": 1,
      "signingUrl": "https://app.tiquo.co/sign/<unique-signer-token>"
    },
    {
      "recipientId": 12,
      "name": "Ash Drew",
  ...
  "recipients": [
    {
      ...
      "role": "SIGNER",
      "signingOrder": null,
      "signingUrl": "https://app.tiquo.co/sign/<signing-token>"
    }
  ]
}
```
...
Check out the endpoint in the [API V1 documentation](https://app.tiquo.co/api/v1/openapi#:~:text=/%7BtemplateId%7D/-,generate,-%2Ddocument).
...
Check out the endpoint in the [API V2 documentation](https://openapi.tiquo.co/reference#tag/template/POST/template/use).
