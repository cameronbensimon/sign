...
Check out the [API V1 documentation](https://app.tiquo.co/api/v1/openapi) for details about the API endpoints, request parameters, response formats, and authentication methods.
...
<Callout type="info">
  For the staging API, please use the following base URL: `https://stg-app.tiquo.co/api/v2-beta/`
</Callout>
