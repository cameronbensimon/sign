...
This will copy the URL to your clipboard, e.g. `https://stg-app.tiquo.co/d/-WoSwWVT-fYOERS2MI37k`
...
So `https://stg-app.tiquo.co/sign/lm7Tp2_yhvFfzdeJQzYQF` will become `lm7Tp2_yhvFfzdeJQzYQF`
