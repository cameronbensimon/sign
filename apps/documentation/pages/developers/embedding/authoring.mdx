...
You can find more details on this request at our [API Documentation](https://openapi.tiquo.co/reference#tag/embedding)
...
| `host`             | string  | Optional custom host URL. Defaults to `https://app.tiquo.co`.     |
