...
Navigate to the [Documenso dashboard](https://app.tiquo.co/documents) and click on the "Add a document" button. Select the document you want to upload and wait for the upload to complete.
...
```bash
https://app.tiquo.co/sign/12ACP777zxQLO52hjj_vCB
```
