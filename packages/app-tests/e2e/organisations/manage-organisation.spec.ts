...
test('[ORGANISATIONS]: inherit members', async ({ page }) => {
  ...
  const memberEmail = `member-${nanoid()}@test.tiquo.co`;
  const memberEmail2 = `member-2-${nanoid()}@test.tiquo.co`;
  const memberEmail3 = `member-3-${nanoid()}@test.tiquo.co`;
  const managerEmail = `manager-${nanoid()}@test.tiquo.co`;
  const adminEmail = `admin-${nanoid()}@test.tiquo.co`;
...
test('[ORGANISATIONS]: manage groups and members', async ({ page }) => {
  ...
  const memberEmail1 = `member-1-${nanoid()}@test.tiquo.co`;
  const memberEmail2 = `member-2-${nanoid()}@test.tiquo.co`;
  const memberEmail3 = `member-3-${nanoid()}@test.tiquo.co`;
  const memberEmail4 = `member-4-${nanoid()}@test.tiquo.co`;
  const memberEmail5 = `member-5-${nanoid()}@test.tiquo.co`;
  const memberEmail6 = `member-6-${nanoid()}@test.tiquo.co`;

  const adminEmail1 = `admin-1-${nanoid()}@test.tiquo.co`;
  const adminEmail2 = `admin-2-${nanoid()}@test.tiquo.co`;
  const adminEmail3 = `admin-3-${nanoid()}@test.tiquo.co`;
