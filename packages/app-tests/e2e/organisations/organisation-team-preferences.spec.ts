...
test('[ORGANISATIONS]: manage branding preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Brand Website' }).fill('https://tiquo.co');
  ...
  expect(teamSettings.brandingUrl).toEqual('https://tiquo.co');
  ...
  expect(inheritedTeamSettings.brandingUrl).toEqual('https://tiquo.co');
...
test('[ORGANISATIONS]: manage email preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Reply to email' }).fill('organisation@tiquo.co');
  ...
  // Check that the team settings have inherited these values.
  expect(teamSettings.emailReplyTo).toEqual('organisation@tiquo.co');
  ...
  // Check that the team settings now inherit from organisation again.
  expect(inheritedTeamSettings.emailReplyTo).toEqual('organisation@tiquo.co');
  ...
  expect(documentMeta.emailReplyTo).toEqual('organisation@tiquo.co');
